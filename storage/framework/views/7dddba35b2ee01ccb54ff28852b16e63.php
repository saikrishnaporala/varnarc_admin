                                    ...
                                    <div class="live-preview">
                                        ...
                                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                                                ...
                                                <div data-simplebar style="height: calc(100vh - 112px);">
                                                    <div class="acitivity-timeline p-4">
                                                        <div class="acitivity-item d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                                    <div class="col-4">
                                                                        <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="img-fluid rounded" />
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="img-fluid rounded" />
                                                                    </div>
                                                                    <div class="col-4">
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="acitivity-item d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="offcanvas-foorter border-top p-3 text-center">
                                                <a href="javascript:void(0);" class="link-success">View All Activity <i class="ri-arrow-right-s-line align-middle ms-1"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row gallery-light">
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card light mb-0">
                                                            <div class="gallery-container">
                                                                <a href="#" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" />
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card light mb-0">
                                                            <div class="gallery-container">
                                                                <a href="#" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" />
                                                                    <div class="gallery-overlay">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                                        <div class="gallery-box card mb-0">
                                                            <div class="gallery-container">
                                                                <a href="#" title="">
                                                                    <img class="gallery-img img-fluid mx-auto" src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" />
                                                                    <div class="gallery-overlay">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/saiporala/Documents/Varnarc/varnarc_admin/resources/views/ui-offcanvas.blade.php ENDPATH**/ ?>