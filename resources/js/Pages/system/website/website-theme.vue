            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  <div class="content page-container" id="page-List/Website Theme/List" data-page-route="List/Website Theme/List" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="Website Theme">Website Theme</h3>
                          ...
                          <div class="flex col page-actions justify-content-end">
                            ...
                            <div class="standard-actions flex">
                              ...
                              <button class="btn btn-primary btn-sm primary-action" data-label="Add Website Theme">
                                <svg class="icon  icon-xs" style="" aria-hidden="true">
                                  <use class="" href="#icon-add"></use>
                                </svg>
                                <span class="hidden-xs" data-label="Add%20Website%20Theme"> <span><span class="alt-underline">A</span>dd Website Theme</span> </span>
                              </button>
                            </div>
                          </div>
                        </div>
                                      ...
                                      <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>      <a class="dropdown-item option" data-value="theme">       Theme      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="module">       Module      </a>     </li>
                                          </ul>
                                        </button>
                                      </div>
                                    </div>
                                  ...
                                  <div class="result">
                                    <header class="level list-row-head text-muted">
                                      <div class="level-left list-header-subject">
                                        ...
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="theme" title="Click to sort by Theme">Theme</span></div>
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="module" title="Click to sort by Module">Module</span></div>
                                      </div>
                                    ...
                                    <div class="list-row-container" tabindex="1">
                                      <div class="level list-row">
                                        <div class="level-left ellipsis">
                                          <div class="list-row-col ellipsis list-subject level ">
                                            <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Website Theme" data-name="Standard"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Website Theme" data-name="Standard" href="/app/website-theme/Standard" title="Standard">Standard</a></span>
                                          </div>
                                          <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                            <div class="tags-empty">-</div>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Theme: Standard">
                                            <a class="filterable ellipsis" data-filter="theme,=,Standard">
                                            Standard
                                            </a>
                                            </span>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Module: Website">
                                            <a class="filterable ellipsis" data-filter="module,=,Website">
                                            Website
                                            </a>
                                            </span>
                                          </div>
                                        ...
                                        <div class="level-right text-muted ellipsis">
                                          <div class="level-item list-row-activity hidden-xs">
                                            ...
                                            <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2020-06-15 13:10:16.618476" title="15-06-2020 13:10:16">4 y</span></span>
                                            ...
                                            <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                              <span class="like-action not-liked" data-doctype="Website Theme" data-name="Standard" data-liked-by="" title="">
                                                <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                                  <use class="like-icon" href="#es-solid-heart"></use>
                                                </svg>
                                              </span>
                                  ...
                                  <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                                    <div class="no-result text-muted flex justify-center align-center">
                                      <div class="msg-box no-border">
                                        ...
                                        <p>You haven't created a Website Theme yet</p>
                                  ...
                                  <div class="form-layout">
                                    ...
                                    <div class="form-page">
                                      <div class="form-tabs-list">
                                        <ul class="nav form-tabs" id="form-tabs" role="tablist">
                                          <li class="nav-item show">
                                            <a class="nav-link active" id="website-theme-bootstrap_theme_section-tab" data-toggle="tab" data-fieldname="bootstrap_theme_section" href="#website-theme-bootstrap_theme_section" role="tab" aria-controls="website-theme-bootstrap_theme_section" aria-selected="true">
                                            Theme Configuration
                                            </a>
                                          </li>
                                          <li class="nav-item show">
                                            <a class="nav-link " id="website-theme-stylesheet_section-tab" data-toggle="tab" data-fieldname="stylesheet_section" href="#website-theme-stylesheet_section" role="tab" aria-controls="website-theme-stylesheet_section">
                                            Stylesheet
                                            </a>
                                          </li>
                                          <li class="nav-item show">
                                            <a class="nav-link " id="website-theme-custom_js_section-tab" data-toggle="tab" data-fieldname="custom_js_section" href="#website-theme-custom_js_section" role="tab" aria-controls="website-theme-custom_js_section">
                                            Script
                                            </a>
                                          </li>
                                        </ul>
                                      ...
                                      <div class="form-tab-content tab-content">
                                        <div class="tab-pane fade show active" id="website-theme-bootstrap_theme_section" role="tabpanel" aria-labelledby="website-theme-bootstrap_theme_section-tab">
                                          <div class="form-dashboard">
                                            ...
                                            <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                              ...
                                              <div class="section-body">
                                                <div id="heatmap-website_theme" class="heatmap"></div>
                                          ...
                                          <div class="row form-section card-section visible-section" data-fieldname="__section_2">
                                            <div class="section-body">
                                              <div class="form-column col-sm-6" data-fieldname="__column_2">
                                                <form>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="theme">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label reqd" style="padding-right: 0px;">Theme</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Data" data-fieldname="theme" placeholder="" data-doctype="Website Theme"></div>
                                                        <div class="control-value like-disabled-input bold" style="display: none;"></div>
                                                        <p class="help-box small text-muted"></p>
                                                      </div>
                                                    </div>
                                                    <span class="tooltip-content">theme</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width hide-control" data-fieldtype="Link" data-fieldname="module">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label reqd" style="padding-right: 0px;">Module</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Link" data-fieldname="module" placeholder="" data-doctype="Website Theme" data-target="Module Def" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_3" role="combobox">
                                                        ...
                                                        <div class="control-value like-disabled-input bold" style="display: none;"><a href="/app/module-def/Website" data-doctype="Module Def" data-name="Website" data-value="Website">Website</a></div>
                                                        <p class="help-box small text-muted"></p>
                                                      </div>
                                                    </div>
                                                    <span class="tooltip-content">module</span>
                                                  </div>
                                                  <div class="form-group frappe-control input-max-width hide-control" data-fieldtype="Check" data-fieldname="custom">
                                                    <div class="checkbox">
                                                      <label>
                                                      <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="custom" placeholder="" data-doctype="Website Theme"></span>
                                                      <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-selected"></span>
                                                      <span class="label-area">Custom?</span>
                                                      <span class="ml-1 help"></span>
                                                      </label>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                    <span class="tooltip-content">custom</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="google_font">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Google Font</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Data" data-fieldname="google_font" placeholder="" data-doctype="Website Theme"></div>
                                                        <div class="control-value like-disabled-input" style="display: none;"></div>
                                                        <p class="help-box small text-muted"></p>
                                                      </div>
                                                    </div>
                                                    <span class="tooltip-content">google_font</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="font_size">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Font Size</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Data" data-fieldname="font_size" placeholder="" data-doctype="Website Theme"></div>
                                                        <div class="control-value like-disabled-input" style="display: none;"></div>
                                                        <p class="help-box small text-muted"></p>
                                                      </div>
                                                    </div>
                                                    <span class="tooltip-content">font_size</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="font_properties">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Font Properties</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Data" data-fieldname="font_properties" placeholder="" data-doctype="Website Theme"></div>
                                                        <div class="control-value like-disabled-input" style="display: none;">wght@300;400;500;600;700;800</div>
                                                        <p class="help-box small text-muted"></p>
                                                      </div>
                                                    </div>
                                                    <span class="tooltip-content">font_properties</span>
                                                  </div>
                                                  <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="button_rounded_corners">
                                                    <div class="checkbox">
                                                      <label>
                                                      <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="button_rounded_corners" placeholder="" data-doctype="Website Theme"></span>
                                                      <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-selected"></span>
                                                      <span class="label-area">Button Rounded Corners</span>
                                                      <span class="ml-1 help"></span>
                                                      </label>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                    <span class="tooltip-content">button_rounded_corners</span>
                                                  </div>
                                                  <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="button_shadows">
                                                    <div class="checkbox">
                                                      <label>
                                                      <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="button_shadows" placeholder="" data-doctype="Website Theme"></span>
                                                      <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                      <span class="label-area">Button Shadows</span>
                                                      <span class="ml-1 help"></span>
                                                      </label>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                    <span class="tooltip-content">button_shadows</span>
                                                  </div>
                                                  <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="button_gradients">
                                                    <div class="checkbox">
                                                      <label>
                                                      <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="button_gradients" placeholder="" data-doctype="Website Theme"></span>
                                                      <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                      <span class="label-area">Button Gradients</span>
                                                      <span class="ml-1 help"></span>
                                                      </label>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                    <span class="tooltip-content">button_gradients</span>
                                                  </div>
                                                </form>
                                              </div>
                                              <div class="form-column col-sm-6" data-fieldname="column_break_11">
                                                <form>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="primary_color">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Primary Color</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="primary_color" placeholder="" data-doctype="Website Theme" data-target="Color" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_4" role="combobox">
                                                    ...
                                                    <span class="tooltip-content">primary_color</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="text_color">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Text Color</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="text_color" placeholder="" data-doctype="Website Theme" data-target="Color" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_5" role="combobox">
                                                    ...
                                                    <span class="tooltip-content">text_color</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="light_color">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Light Color</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="light_color" placeholder="" data-doctype="Website Theme" data-target="Color" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_6" role="combobox">
                                                    ...
                                                    <span class="tooltip-content">light_color</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="dark_color">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Dark Color</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="dark_color" placeholder="" data-doctype="Website Theme" data-target="Color" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_7" role="combobox">
                                                    ...
                                                    <span class="tooltip-content">dark_color</span>
                                                  </div>
                                                  <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="background_color">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Background Color</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                          <div class="link-field ui-front" style="position: relative;">
                                                            <div class="awesomplete">
                                                              <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="background_color" placeholder="" data-doctype="Website Theme" data-target="Color" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_8" role="combobox">
                                                    ...
                                                    <span class="tooltip-content">background_color</span>
                                                  </div>
                                                </form>
                                              </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade show" id="website-theme-stylesheet_section" role="tabpanel" aria-labelledby="website-theme-stylesheet_section-tab">
                                          <div class="row form-section card-section visible-section" data-fieldname="__section_3">
                                            <div class="section-body">
                                              <div class="form-column col-sm-12" data-fieldname="__column_3">
                                                <form>
                                                  <div class="frappe-control" data-fieldtype="Code" data-fieldname="custom_overrides">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Custom Overrides</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                    ...
                                                    <span class="tooltip-content">custom_overrides</span>
                                                  </div>
                                                  <div class="frappe-control" data-fieldtype="Code" data-fieldname="custom_scss">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">Custom SCSS</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                    ...
                                                    <span class="tooltip-content">custom_scss</span>
                                                  </div>
                                                  <div class="frappe-control form-group" data-fieldtype="Table" data-fieldname="ignored_apps" style="display: none;">
                                                    <span class="tooltip-content">ignored_apps</span>
                                                    <div class="grid-field">
                                                      <label class="control-label">Ignored Apps</label>
                                                      <span class="help"></span>
                                                          ...
                                                          <div class="grid-heading-row">
                                                            <div class="grid-row">
                                                              <div class="data-row row">
                                                                ...
                                                                <div class="col grid-static-col col-xs-10 " data-fieldname="app" data-fieldtype="Data" title="App">
                                                                  <div class="field-area" style="display: none;"></div>
                                                                  <div class="static-area ellipsis reqd">App</div>
                                                                </div>
                                                  ...
                                                  <div>
                                                    <div class="form-layout">
                                                      <div class="form-message hidden"></div>
                                                      <div class="form-page">
                                                        <div class="row form-section visible-section" data-fieldname="__section_1" style="padding: 0px; margin-left: -15px; margin-right: -15px;">
                                                          <div class="section-body">
                                                            <div class="form-column col-sm-12" data-fieldname="__column_1">
                                                <form>
                                                <div class="frappe-control" data-fieldtype="MultiCheck" data-fieldname="apps"><span class="tooltip-content">apps</span><label class="control-label">Include Theme from Apps</label><div class="bulk-select-options" style="display: none;">
                                                ...
                                                </div><div class="load-state text-muted small" style="display: none;">Loading...</div><div class="checkbox-options" style="--checkbox-options-columns: 4;"><div class="checkbox unit-checkbox">
                                                <label title="">
                                                <input type="checkbox" data-unit="email_delivery_service">
                                                <span class="label-area" data-unit="email_delivery_service">Email Delivery Service</span>
                                                </label>
                                                </div><div class="checkbox unit-checkbox">
                                                <label title="">
                                                <input type="checkbox" data-unit="erpnext">
                                                <span class="label-area" data-unit="erpnext">ERPNext</span>
                                                </label>
                                                </div><div class="checkbox unit-checkbox">
                                                <label title="">
                                                <input type="checkbox" data-unit="frappe">
                                                <span class="label-area" data-unit="frappe">Frappe Framework</span>
                                                </label>
                                                </div><div class="checkbox unit-checkbox">
                                                <label title="">
                                                <input type="checkbox" data-unit="india_compliance">
                                                <span class="label-area" data-unit="india_compliance">India Compliance</span>
                                                </label>
                                                </div></div></div></form>
                                                </div></div></div></div></div></div>
                                                <div class="frappe-control hide-control" data-fieldtype="Code" data-fieldname="theme_scss">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <button class="btn icon-btn" style="position: absolute; top: 32px; right: 5px;" onmouseover="this.classList.add('btn-default')" onmouseout="this.classList.remove('btn-default')">
                                                    <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                                      <use class="" href="#es-line-copy-light"></use>
                                                    </svg>
                                                  </button>
                                                  <span class="tooltip-content">theme_scss</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Data" data-fieldname="theme_url">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">theme_url</span>
                                                </div>
                                                </form>
                                              </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade show" id="website-theme-custom_js_section" role="tabpanel" aria-labelledby="website-theme-custom_js_section-tab">
                                          <div class="row form-section card-section visible-section" data-fieldname="__section_4">
                                            <div class="section-body">
                                              <div class="form-column col-sm-12" data-fieldname="__column_4">
                                                <form>
                                                  <div class="frappe-control" data-fieldtype="Code" data-fieldname="js">
                                                    <div class="form-group">
                                                      <div class="clearfix">
                                                        <label class="control-label" style="padding-right: 0px;">JavaScript</label>
                                                        <span class="help"></span>
                                                      </div>
                                                      <div class="control-input-wrapper">
                                                        <div class="control-input">
                                                    ...
                                                    <span class="tooltip-content">js</span>
                                                  </div>
                                                </form>
                                              </div>
                                            </div>
