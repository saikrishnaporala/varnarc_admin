            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  <div class="content page-container editable-form" id="page-Contact Us Settings" data-page-route="Contact Us Settings" data-state="clean" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="Contact Us Settings">Contact Us Settings</h3>
                            ...
                            <div class="col-lg-2 layout-side-section">
                              <div class="form-sidebar overlay-sidebar hidden-xs hidden-sm">
                                <ul class="list-unstyled sidebar-menu user-actions">
                                  <li class="user-action-row"><a href="/contact" target="_blank">See on Website</a></li>
                                </ul>
                                  ...
                                  <li class="flex">
                                    <div class="form-stats d-flex">
                                      <span class="form-stats-likes">
                                        <span class="liked-by like-action d-flex align-items-center not-liked" data-doctype="Contact Us Settings" data-name="Contact Us Settings">
                                          <svg class="es-icon icon-sm">
                                ...
                                <ul class="list-unstyled sidebar-menu text-muted">
                                  ...
                                  <li class="modified-by"><a href="/app/user/Administrator">Administrator</a> last edited this · <span class="frappe-timestamp " data-timestamp="2024-11-23 15:41:11.976201" title="23-11-2024 15:41:11">yesterday</span></li>
                                  ...
                                  <div class="std-form-layout">
                                    <div class="form-layout">
                                      ...
                                      <div class="form-page">
                                        <div class="form-dashboard">
                                          ...
                                          <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                            ...
                                            <div class="section-body">
                                              <div id="heatmap-contact_us_settings" class="heatmap"></div>
                                        ...
                                        <div class="row form-section card-section visible-section" data-fieldname="introduction_section">
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_2">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="forward_to_email">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Forward To Email Address</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                      <div class="control-value like-disabled-input" style="display: none;"></div>
                                                      <p class="help-box small text-muted">Send enquiries to this email address</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">forward_to_email</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="heading">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Heading</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                      <div class="control-value like-disabled-input" style="display: none;"></div>
                                                      <p class="help-box small text-muted">Default: "Contact Us"</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">heading</span>
                                                </div>
                                                <div class="frappe-control" data-fieldtype="Text Editor" data-fieldname="introduction">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Introduction</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      ...
                                                      <p class="help-box small text-muted">Introductory information for the Contact Us Page</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">introduction</span>
                                                </div>
                                                <div class="frappe-control" data-fieldtype="Small Text" data-fieldname="query_options">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Query Options</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><textarea type="text" autocomplete="off" class="input-with-feedback form-control" data-fieldtype="Small Text" data-fieldname="query_options" placeholder="" data-doctype="Contact Us Settings" style="height: 150px;"></textarea></div>
                                                      <div class="control-value like-disabled-input for-description" style="display: none; white-space-collapse: preserve;"></div>
                                                      <p class="help-box small text-muted">Contact options, like "Sales Query, Support Query" etc each on a new line or separated by commas.</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">query_options</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="address">
                                          <div class="section-head">
                                            Address
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-6" data-fieldname="__column_3">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="address_title">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Address Title</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                  ...
                                                  <span class="tooltip-content">address_title</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="address_line1">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Address Line 1</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                  ...
                                                  <span class="tooltip-content">address_line1</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="address_line2">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Address Line 2</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                  ...
                                                  <span class="tooltip-content">address_line2</span>
                                                </div>
                                                ...
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="pincode">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Pincode</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                  ...
                                                  <span class="tooltip-content">pincode</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="country">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                            ...
                                            <div class="form-column col-sm-6" data-fieldname="column_break_14">
                                              <form>
                                                ...
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="email_id">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Email Id</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                ...
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="skype">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Skype</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control"></div>
                                                  ...
                                                  <span class="tooltip-content">skype</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                  ...
                                  <div class="after-save">
                                    ...
                                    <div class="new-timeline">
                                      ...
                                      <div class="timeline-items">
                                        ...
                                        <div class="timeline-item" data-timestamp="2024-11-23 15:41:11.976201">
                                          <div class="timeline-dot"></div>
                                          <div class="timeline-content "><a href="/app/user/Administrator">Administrator</a> last edited this<span> · <span class="frappe-timestamp " data-timestamp="2024-11-23 15:41:11.976201" title="23-11-2024 15:41:11">yesterday</span></span></div>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
