            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  <div class="content page-container editable-form" id="page-Website Script" data-page-route="Website Script" data-state="clean" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="Website Script">Website Script</h3>
                            ...
                            <div class="col-lg-2 layout-side-section">
                              <div class="form-sidebar overlay-sidebar hidden-xs hidden-sm">
                                  ...
                                  <li class="flex">
                                    <div class="form-stats d-flex">
                                      <span class="form-stats-likes">
                                        <span class="liked-by like-action d-flex align-items-center not-liked" data-doctype="Website Script" data-name="Website Script">
                                          <svg class="es-icon icon-sm">
                                ...
                                <ul class="list-unstyled sidebar-menu text-muted">
                                  ...
                                  <li class="modified-by"><a href="/app/user/Administrator">Administrator</a> last edited this · <span class="frappe-timestamp " data-timestamp="2024-11-23 15:41:11.855567" title="23-11-2024 15:41:11">yesterday</span></li>
                                        ...
                                        <div class="form-dashboard">
                                          ...
                                          <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                            ...
                                            <div class="section-body">
                                              <div id="heatmap-website_script" class="heatmap"></div>
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_1">
                                              <form>
                                                ...
                                                <div class="frappe-control" data-fieldtype="Code" data-fieldname="javascript">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                  ...
                                                  <span class="tooltip-content">javascript</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                  ...
                                  <div class="after-save">
                                    ...
                                    <div class="new-timeline">
                                      ...
                                      <div class="timeline-items">
                                        ...
                                        <div class="timeline-item" data-timestamp="2024-11-23 15:41:11.855567">
                                          <div class="timeline-dot"></div>
                                          <div class="timeline-content "><a href="/app/user/Administrator">Administrator</a> last edited this<span> · <span class="frappe-timestamp " data-timestamp="2024-11-23 15:41:11.855567" title="23-11-2024 15:41:11">yesterday</span></span></div>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
