...
<template>
  <Layout>
    ...
    <PageHeader title="Templates" pageTitle="Emails/Notifications" subTitle="Email"/>
            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  ...
                  <div class="content page-container" id="page-List/Email Template/List" data-page-route="List/Email Template/List" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="Email Template">Email Template</h3>
                          ...
                          <div class="flex col page-actions justify-content-end">
                            ...
                            <div class="standard-actions flex">
                              ...
                              <button class="btn btn-primary btn-sm primary-action" data-label="Add Email Template">
                                <svg class="icon  icon-xs" style="" aria-hidden="true">
                                  <use class="" href="#icon-add"></use>
                                </svg>
                                <span class="hidden-xs" data-label="Add%20Email%20Template"> <span><span class="alt-underline">A</span>dd Email Template</span> </span>
                              </button>
                            </div>
                          </div>
                        </div>
                                      ...
                                      <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>      <a class="dropdown-item option" data-value="response">       Response      </a>     </li>
                                          </ul>
                                        </button>
                                      </div>
                                    </div>
                                  ...
                                  <div class="result">
                                    <header class="level list-row-head text-muted">
                                      <div class="level-left list-header-subject">
                                        ...
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="subject" title="Click to sort by Subject">Subject</span></div>
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="response" title="Click to sort by Response">Response</span></div>
                                      </div>
                                    ...
                                    <div class="list-row-container" tabindex="1">
                                      <div class="level list-row">
                                        <div class="level-left ellipsis">
                                          <div class="list-row-col ellipsis list-subject level ">
                                            <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Email Template" data-name="Dispatch Notification"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Email Template" data-name="Dispatch Notification" href="/app/email-template/Dispatch%20Notification" title="Dispatch Notification">Dispatch Notification</a></span>
                                          </div>
                                          <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                            <div class="tags-empty">-</div>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Subject: Your order is out for delivery!">
                                            <a class="filterable ellipsis" data-filter="subject,=,Your order is out for delivery!">
                                            Your order is out for delivery!
                                            </a>
                                            </span>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Response: Dispatch Notification
                                              Details:
                                              Customer's Name
                                              {{ customer }}
                                              Contact's Name
                                        ...
                                        <div class="level-right text-muted ellipsis">
                                          <div class="level-item list-row-activity hidden-xs">
                                            ...
                                            <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:03.135974" title="24-11-2024 14:01:03">7 h</span></span>
                                            ...
                                            <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                              <span class="like-action not-liked" data-doctype="Email Template" data-name="Dispatch Notification" data-liked-by="" title="">
                                                <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                                  <use class="like-icon" href="#es-solid-heart"></use>
                                                </svg>
                                              </span>
                                    ...
                                    <div class="list-row-container" tabindex="1">
                                      <div class="level list-row">
                                        <div class="level-left ellipsis">
                                          <div class="list-row-col ellipsis list-subject level ">
                                            <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Email Template" data-name="Purchase Reconciliation"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Email Template" data-name="Purchase Reconciliation" href="/app/email-template/Purchase%20Reconciliation" title="Purchase Reconciliation">Purchase Reconciliation</a></span>
                                          </div>
                                          <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                            <div class="tags-empty">-</div>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Subject: 2A/2B Reconciliation for {{ supplier_name }}-{{ supplier_gstin }}">
                                            <a class="filterable ellipsis" data-filter="subject,=,2A/2B Reconciliation for {{ supplier_name }}-{{ supplier_gstin }}">
                                            2A/2B Reconciliation for {{ supplier_name }}-{{ supplier_gstin }}
                                            </a>
                                            </span>
                                          </div>
                                          <div class="list-row-col ellipsis hidden-xs ">
                                            <span class="ellipsis" title="Response: Hello,We have made a purchase reconciliation for the period {{ inward_supply_from_date }} to {{ inward_supply_to_date }} for purchases made by {{ company }} from you.You are requested to kindly make necessary corrections to the GST Portal on your end if required. The attached sheet is for your reference.">
                                            <span class="ellipsis">
                                            Hello,We have made a purchase reconciliation for the period {{ inward_supply_from_date }} to {{ inward_supply_to_date }} for purchases made by {{ company }} from you.You are requested to kindly make necessary corrections to the GST Portal on your end if required. The attached sheet is for your reference.
                                            </span>
                                            </span>
                                          </div>
                                        </div>
                                        <div class="level-right text-muted ellipsis">
                                          <div class="level-item list-row-activity hidden-xs">
                                            ...
                                            <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-23 15:42:56.960928" title="23-11-2024 15:42:56">1 d</span></span>
                                            <span class="comment-count d-flex align-items-center">
                                              <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                                <use class="" href="#es-line-chat-alt"></use>
                                              </svg>
                                            ...
                                            <span class="mx-2">·</span>
                                            <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                              <span class="like-action not-liked" data-doctype="Email Template" data-name="Purchase Reconciliation" data-liked-by="" title="">
                                                <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                                  <use class="like-icon" href="#es-solid-heart"></use>
                                                </svg>
                                              </span>
                                  ...
                                  <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                                    <div class="no-result text-muted flex justify-center align-center">
                                      <div class="msg-box no-border">
                                        ...
                                        <p>You haven't created a Email Template yet</p>
                                      ...
                                      <div class="form-dashboard">
                                        ...
                                        <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                          ...
                                          <div class="section-body">
                                            <div id="heatmap-email_template" class="heatmap"></div>
                                            ...
                                            <form>
                                              <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="__newname">
                                                <div class="form-group">
                                                  ...
                                                  <div class="control-input-wrapper">
                                                    <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Data" data-fieldname="__newname" placeholder="" data-doctype="Email Template"></div>
                                              ...
                                              <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="subject">
                                                <div class="form-group">
                                                  ...
                                                  <div class="control-input-wrapper">
                                                    <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Data" data-fieldname="subject" placeholder="" data-doctype="Email Template"></div>
                                                    <div class="control-value like-disabled-input bold" style="display: none;"></div>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                </div>
                                              ...
                                              <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="use_html">
                                                <div class="checkbox">
                                                  <label>
                                                  <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="use_html" placeholder="" data-doctype="Email Template"></span>
                                                  <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                  <span class="label-area">Use HTML</span>
                                                  <span class="ml-1 help"></span>
                                                  </label>
                                                  <p class="help-box small text-muted"></p>
                                                </div>
                                                <span class="tooltip-content">use_html</span>
                                              </div>
                                              <div class="frappe-control hide-control" data-fieldtype="Code" data-fieldname="response_html">
                                                <div class="form-group">
                                                  <div class="clearfix">
                                                    <label class="control-label" style="padding-right: 0px;">Response </label>
                                                    <span class="help"></span>
                                                  </div>
                                                  <div class="control-input-wrapper">
                                                ...
                                                <span class="tooltip-content">response_html</span>
                                              </div>
                                              <div class="frappe-control" data-fieldtype="Text Editor" data-fieldname="response">
                                                <div class="form-group">
                                                  <div class="clearfix">
                                                    <label class="control-label reqd" style="padding-right: 0px;">Response</label>
                                                    <span class="help"></span>
                                                  </div>
                                                  <div class="control-input-wrapper">
                                                    <div class="control-input">
                                                ...
                                                <span class="tooltip-content">response</span>
                                              </div>
                                            </form>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row form-section card-section visible-section" data-fieldname="section_break_4">
                                        <div class="section-body">
                                          <div class="form-column col-sm-12" data-fieldname="__column_2">
                                            <form>
                                              <div class="frappe-control" data-fieldtype="HTML" data-fieldname="email_reply_help">
