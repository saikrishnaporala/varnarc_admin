...
<template>
  <Layout>
    <Head title="Auto Email Report" />
    <PageHeader title="Auto Email Report" pageTitle="Emails/Notifications" subTitle="Email"/>
            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  ...
                  <div class="content page-container" id="page-List/Auto Email Report/List" data-page-route="List/Auto Email Report/List" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="Auto Email Report">Auto Email Report</h3>
                          ...
                          <div class="flex col page-actions justify-content-end">
                            ...
                            <div class="standard-actions flex">
                              ...
                              <button class="btn btn-primary btn-sm primary-action" data-label="Add Auto Email Report">
                                <svg class="icon  icon-xs" style="" aria-hidden="true">
                                  <use class="" href="#icon-add"></use>
                                </svg>
                                <span class="hidden-xs" data-label="Add%20Auto%20Email%20Report"> <span><span class="alt-underline">A</span>dd Auto Email Report</span> </span>
                              </button>
                            </div>
                          </div>
                        </div>
                              ...
                              <div class="layout-main-section frappe-card">
                                <div class="page-form flex">
                                  <div class="standard-filter-section flex">
                                    ...
                                    <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Select" data-fieldname="frequency" title="" data-original-title="Frequency">
                                      <select type="text" autocomplete="off" class="input-with-feedback form-control input-xs ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="frequency" placeholder="Frequency">
                                        <option></option>
                                      ...
                                      <span class="tooltip-content">frequency</span>
                                      ...
                                      <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>      <a class="dropdown-item option" data-value="report">       Report      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="user">       Based on Permissions For User      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="email_to">       Email To      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="frequency">       Frequency      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="format">       Format      </a>     </li>
                                          </ul>
                                        </button>
                                      </div>
                                    </div>
                                  ...
                                  <div class="result" style="display: none;">
                                    <header class="level list-row-head text-muted">
                                      <div class="level-left list-header-subject">
                                        ...
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="frequency" title="Click to sort by Frequency">Frequency</span></div>
                                      </div>
                                  ...
                                  <div class="no-result text-muted flex justify-center align-center" style="">
                                    <div class="no-result text-muted flex justify-center align-center">
                                      <div class="msg-box no-border">
                                        ...
                                        <p>You haven't created a Auto Email Report yet</p>
                                        <p><button class="btn btn-default btn-sm btn-new-doc hidden-xs">
                                          Create your first Auto Email Report
                  ...
                  <div class="content page-container editable-form" id="page-Auto Email Report" data-page-route="Auto Email Report" style="" data-state="dirty">
                    <div class="page-head flex">
                      <div class="container">
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="New Auto Email Report">New Auto Email Report</h3>
                            ...
                            <div class="standard-actions flex">
                              ...
                              <div class="menu-btn-group hide">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                  ...
                                  <li>
                                    <a class="grey-link dropdown-item" href="#" onclick="return false;">
                                    <span class="menu-item-label" data-label="New%20Auto%20Email%20Report"><span><span class="alt-underline">N</span>ew Auto Email Report</span></span>
                                    <kbd class="pull-right">
                                    <span>⌘+B</span>
                                    </kbd>
                                    </a>
                                ...
                                <ul class="list-unstyled sidebar-menu form-tags">
                                  ...
                                  <li class="" style="display: none;">
                                    <div class="awesomplete">
                                      <input class="tags-input form-control" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_2" role="combobox">
                                        ...
                                        <div class="form-dashboard">
                                          ...
                                          <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                            ...
                                            <div class="section-body">
                                              <div id="heatmap-auto_email_report" class="heatmap"></div>
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-6" data-fieldname="__column_1">
                                              <form>
                                                ...
                                                <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="report">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Report</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="link-field ui-front" style="position: relative;">
                                                          <div class="awesomplete">
                                                            <input type="text" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Link" data-fieldname="report" placeholder="" data-doctype="Auto Email Report" data-target="Report" autocomplete="off" aria-expanded="true" aria-owns="awesomplete_list_3" role="combobox" aria-activedescendant="awesomplete_list_3_item_0">
                                                            <ul role="listbox" id="awesomplete_list_3">
                                                              <div role="option" aria-selected="true">
                                                                <p title="Asset Depreciation Ledger"><strong>Asset Depreciation Ledger</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Completed Work Orders"><strong>Completed Work Orders</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Gross Profit"><strong>Gross Profit</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Item Shortage Report"><strong>Item Shortage Report</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Item-wise Purchase History"><strong>Item-wise Purchase History</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Item-wise Sales History"><strong>Item-wise Sales History</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Lead Details"><strong>Lead Details</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Sales Partners Commission"><strong>Sales Partners Commission</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Serial No Service Contract Expiry"><strong>Serial No Service Contract Expiry</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Serial No Status"><strong>Serial No Status</strong></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Create a new Report"><span class="link-option"><i class="fa fa-plus" style="margin-right: 5px;"></i> Create a new Report</span></p>
                                                              </div>
                                                              <div role="option">
                                                                <p title="Advanced Search"><span class="link-option"><i class="fa fa-search" style="margin-right: 5px;"></i> Advanced Search</span></p>
                                                              </div>
                                                            </ul>
                                                            <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">12 results found</span>
                                                          </div>
                                                  ...
                                                  <span class="tooltip-content">report</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="user">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Based on Permissions For User</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="link-field ui-front" style="position: relative;">
                                                          <div class="awesomplete">
                                                            <input type="text" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Link" data-fieldname="user" placeholder="" data-doctype="Auto Email Report" data-target="User" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_4" role="combobox">
                                                      ...
                                                      <div class="control-value like-disabled-input bold" style="display: none;"><a href="/app/user/saikrishnaporala%40gmail.com" data-doctype="User" data-name="saikrishnaporala@gmail.com" data-value="saikrishnaporala@gmail.com">saikrishnaporala@gmail.com</a></div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">user</span>
                                                </div>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="enabled">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="enabled" placeholder="" data-doctype="Auto Email Report"></span>
                                            ...
                                            <div class="form-column col-sm-6" data-fieldname="column_break_4">
                                              <form>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Read Only" data-fieldname="report_type">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">report_type</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Data" data-fieldname="reference_report">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">reference_report</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="filter_data">
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_2">
                                              <form>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="send_if_data">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="send_if_data" placeholder="" data-doctype="Auto Email Report"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-selected"></span>
                                                    <span class="label-area">Send only if there is any data</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                  <span class="tooltip-content">send_if_data</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Int" data-fieldname="data_modified_till">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Only Send Records Updated in Last X Hours</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" data-fieldtype="Int" data-fieldname="data_modified_till" placeholder="" data-doctype="Auto Email Report"></div>
                                                      <div class="control-value like-disabled-input" style="display: none;"></div>
                                                      <p class="help-box small text-muted">Zero means send records updated at anytime</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">data_modified_till</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Int" data-fieldname="no_of_rows">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">No of Rows (Max 500)</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" data-fieldtype="Int" data-fieldname="no_of_rows" placeholder="" data-doctype="Auto Email Report"></div>
                                                      <div class="control-value like-disabled-input" style="display: none;">100</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">no_of_rows</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="report_filters">
                                          ...
                                          <div class="section-body hide">
                                            <div class="form-column col-sm-12" data-fieldname="__column_3">
                                              <form>
                                                <div class="frappe-control" data-fieldtype="HTML" data-fieldname="filters_display"><span class="tooltip-content">filters_display</span></div>
                                                <div class="frappe-control hide-control" data-fieldtype="Text" data-fieldname="filters">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">filters</span>
                                                </div>
                                                <div class="frappe-control hide-control" data-fieldtype="Text" data-fieldname="filter_meta">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">filter_meta</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="dynamic_report_filters_section">
                                          <div class="section-head collapsible collapsed">
                                          ...
                                          <div class="section-body hide">
                                            <div class="form-column col-sm-6" data-fieldname="__column_4">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="from_date_field">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">From Date Field</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="from_date_field" placeholder="" data-doctype="Auto Email Report"></select>
                                                  ...
                                                  <span class="tooltip-content">from_date_field</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="to_date_field">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">To Date Field</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="to_date_field" placeholder="" data-doctype="Auto Email Report"></select>
                                                        <div class="select-icon ">
                                                          <svg class="icon  icon-sm" style="" aria-hidden="true">
                                                            <use class="" href="#icon-select"></use>
                                                          </svg>
                                                  ...
                                                  <span class="tooltip-content">to_date_field</span>
                                                </div>
                                              </form>
                                            </div>
                                            <div class="form-column col-sm-6" data-fieldname="column_break_17">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="dynamic_date_period">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Period</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="dynamic_date_period" placeholder="" data-doctype="Auto Email Report">
                                                          <option></option>
                                                          <option value="Daily">Daily</option>
                                                          <option value="Weekly">Weekly</option>
                                                          <option value="Monthly">Monthly</option>
                                                  ...
                                                  <span class="tooltip-content">dynamic_date_period</span>
                                                </div>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="use_first_day_of_period">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="use_first_day_of_period" placeholder="" data-doctype="Auto Email Report"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                    <span class="label-area">Use First Day of Period</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted">To begin the date range at the start of the chosen period. For example, if 'Year' is selected as the period, the report will start from January 1st of the current year.</p>
                                                  </div>
                                                  <span class="tooltip-content">use_first_day_of_period</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        ...
                                        <div class="row form-section card-section visible-section" data-fieldname="email_settings">
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-6" data-fieldname="__column_5">
                                              <form>
                                                <div class="frappe-control" data-fieldtype="Small Text" data-fieldname="email_to">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Email To</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><textarea type="text" autocomplete="off" class="input-with-feedback form-control bold" data-fieldtype="Small Text" data-fieldname="email_to" placeholder="" data-doctype="Auto Email Report" style="height: 150px;"></textarea></div>
                                                      <div class="control-value like-disabled-input for-description bold" style="display: none; white-space-collapse: preserve;">saikrishnaporala@gmail.com</div>
                                                      <p class="help-box small text-muted">For multiple addresses, enter the address on different line. e.g. test@test.com ⏎ test1@test.com</p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">email_to</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Select" data-fieldname="day_of_week">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Day of Week</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="day_of_week" placeholder="" data-doctype="Auto Email Report">
                                                      ...
                                                      <div class="control-value like-disabled-input" style="display: none;">Monday</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">day_of_week</span>
                                                </div>
                                              </form>
                                            </div>
                                            <div class="form-column col-sm-6" data-fieldname="column_break_13">
                                              <form>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="link-field ui-front" style="position: relative;">
                                                          <div class="awesomplete">
                                                            <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="sender" placeholder="" data-doctype="Auto Email Report" data-target="Email Account" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_5" role="combobox">
                                                ...
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="frequency">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Frequency</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis bold" maxlength="140" data-fieldtype="Select" data-fieldname="frequency" placeholder="" data-doctype="Auto Email Report">
                                                          <option value="Daily">Daily</option>
                                                          <option value="Weekdays">Weekdays</option>
                                                          <option value="Weekly">Weekly</option>
                                                          <option value="Monthly">Monthly</option>
                                                      ...
                                                      <div class="control-value like-disabled-input bold" style="display: none;">Daily</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">frequency</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="format">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Format</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis bold" maxlength="140" data-fieldtype="Select" data-fieldname="format" placeholder="" data-doctype="Auto Email Report">
                                                      ...
                                                      <div class="control-value like-disabled-input bold" style="display: none;">HTML</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">format</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="section_break_15">
                                          <div class="section-head collapsible collapsed">
                                            Message
                                            <span class="ml-2 collapse-indicator mb-1" style="">
                                              <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          ...
                                          <div class="section-body hide">
                                            <div class="form-column col-sm-12" data-fieldname="__column_6">
                                              <form>
                                                <div class="frappe-control" data-fieldtype="Text Editor" data-fieldname="description">
                                                  <div class="form-group">
                                                    <div class="clearfix">
