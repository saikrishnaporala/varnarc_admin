...
<template>
  <Layout>
    <Head title="Email Newsletter" />
    <PageHeader title="Email News Letter" pageTitle="Emails/Notifications" subTitle="Email"/>
            ...
            <BCard no-body>
              <BCardBody class="pt-0">
                <BCol xl="12" class="mt-3">
                  <div class="content page-container" id="page-List/Newsletter/List" data-page-route="List/Newsletter/List" style="">
                        ...
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="" data-original-title="Create and send emails to a specific group of subscribers periodically.">Newsletter</h3>
                          ...
                          <div class="flex col page-actions justify-content-end">
                            ...
                            <div class="standard-actions flex">
                              ...
                              <button class="btn btn-primary btn-sm primary-action" data-label="Add Newsletter">
                                <svg class="icon  icon-xs" style="" aria-hidden="true">
                                  <use class="" href="#icon-add"></use>
                                </svg>
                                <span class="hidden-xs" data-label="Add%20Newsletter"> <span><span class="alt-underline">A</span>dd Newsletter</span> </span>
                              </button>
                            </div>
                          </div>
                        </div>
                                ...
                                <div class="page-form flex">
                                  ...
                                  <div class="filter-section flex">
                                    ...
                                    <div class="sort-selector">
                                      <div class="btn-group">
                                        <button class="btn btn-default btn-sm btn-order" data-value="asc" title="ascending">
                                          <span class="sort-order">
                                            <svg class="icon icon-sm">
                                              <use href="#icon-sort-ascending"></use>
                                            </svg>
                                          </span>
                                        </button>
                                        <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>      <a class="dropdown-item option" data-value="sender_email">       Sender Email      </a>     </li>
                                            <li>      <a class="dropdown-item option" data-value="message">       Message      </a>     </li>
                                          </ul>
                                        </button>
                                      </div>
                                    </div>
                                  ...
                                  <div class="result" style="display: none;">
                                    <header class="level list-row-head text-muted">
                                      <div class="level-left list-header-subject">
                                        ...
                                        <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="message" title="Click to sort by Message">Message</span></div>
                                  ...
                                  <div class="no-result text-muted flex justify-center align-center" style="">
                                    <div class="no-result text-muted flex justify-center align-center">
                                      <div class="msg-box no-border">
                                        ...
                                        <p>Create and send emails to a specific group of subscribers periodically.</p>
                  ...
                  <div class="content page-container editable-form" id="page-Newsletter" data-page-route="Newsletter" style="" data-state="dirty">
                    <div class="page-head flex">
                      <div class="container">
                        <div class="row flex align-center page-head-content justify-between">
                          <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                            ...
                            <div class="flex fill-width title-area">
                              <div>
                                <div class="flex">
                                  <h3 class="ellipsis title-text" title="New Newsletter">New Newsletter</h3>
                            ...
                            <div class="standard-actions flex">
                              ...
                              <div class="menu-btn-group hide">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                  ...
                                  <li>
                                    <a class="grey-link dropdown-item" href="#" onclick="return false;">
                                    <span class="menu-item-label" data-label="New%20Newsletter"><span><span class="alt-underline">N</span>ew Newsletter</span></span>
                                    <kbd class="pull-right">
                                    <span>⌘+B</span>
                                    </kbd>
                                    </a>
                                  ...
                                  <div class="std-form-layout">
                                    <div class="form-layout">
                                      ...
                                      <div class="form-page">
                                        <div class="form-dashboard">
                                          ...
                                          <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                                            ...
                                            <div class="section-body">
                                              <div id="heatmap-newsletter" class="heatmap"></div>
                                        ...
                                        <div class="row form-section card-section hide-control" data-fieldname="status_section">
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-4" data-fieldname="__column_2">
                                              <form>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Datetime" data-fieldname="email_sent_at">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">email_sent_at</span>
                                                </div>
                                              </form>
                                            </div>
                                            <div class="form-column col-sm-4" data-fieldname="column_break_3">
                                              <form>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Int" data-fieldname="total_recipients">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">total_recipients</span>
                                                </div>
                                              </form>
                                            </div>
                                            <div class="form-column col-sm-4" data-fieldname="column_break_12">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Int" data-fieldname="total_views">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Total Views</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                  ...
                                                  <span class="tooltip-content">total_views</span>
                                                </div>
                                                <div class="form-group frappe-control input-max-width hide-control" data-fieldtype="Check" data-fieldname="email_sent">
                                                  <div class="checkbox">
                                                    <label>
                                                  ...
                                                  <span class="tooltip-content">email_sent</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="from_section">
                                          <div class="section-head">
                                            From
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-4" data-fieldname="__column_3">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="sender_name">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Sender Name</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Data" data-fieldname="sender_name" placeholder="" data-doctype="Newsletter"></div>
                                                      <div class="control-value like-disabled-input" style="display: none;">Sai</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">sender_name</span>
                                                </div>
                                              </form>
                                            </div>
                                            <div class="form-column col-sm-4" data-fieldname="column_break_5">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Data" data-fieldname="sender_email">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label reqd" style="padding-right: 0px;">Sender Email</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><input type="text" autocomplete="off" class="input-with-feedback form-control bold" maxlength="140" data-fieldtype="Data" data-fieldname="sender_email" placeholder="" data-doctype="Newsletter"></div>
                                                      <div class="control-value like-disabled-input bold" style="display: none;">saikrishnaporala@gmail.com</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="form-column col-sm-4" data-fieldname="column_break_7">
                                              <form>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Data" data-fieldname="send_from">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">send_from</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="recipients">
                                          <div class="section-head">
                                            To
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_4">
                                              <form>
                                                <div class="frappe-control form-group" data-fieldtype="Table" data-fieldname="email_group">
                                                  <span class="tooltip-content">email_group</span>
                                                  <div class="grid-field">
                                                    ...
                                                    <div class="form-grid-container">
                                                      <div class="form-grid">
                                                        <div class="grid-heading-row">
                                                          <div class="grid-row">
                                                            <div class="data-row row">
                                                              ...
                                                              <div class="col grid-static-col col-xs-7 " data-fieldname="email_group" data-fieldtype="Link" title="Email Group">
                                                                <div class="field-area" style="display: none;"></div>
                                                                <div class="static-area ellipsis reqd">Email Group</div>
                                                              </div>
                                                              <div class="col grid-static-col col-xs-3 " data-fieldname="total_subscribers" data-fieldtype="Read Only" title="Total Subscribers">
                                                                <div class="field-area" style="display: none;"></div>
                                                                <div class="static-area ellipsis">Total Subscribers</div>
                                                              </div>
                                                        ...
                                                        <div class="grid-body">
                                                          <div class="rows">
                                                            <div class="grid-row" data-name="new-newsletter-email-group-tlkdqlcpqo" data-idx="1">
                                                              <div class="data-row row">
                                                                <div class="row-check sortable-handle col">
                                                                  <input type="checkbox" class="grid-row-check">
                                                                </div>
                                                                ...
                                                                <div class="col grid-static-col col-xs-7 error bold" data-fieldname="email_group" data-fieldtype="Link">
                                                                  <div class="field-area" style="display: none;"></div>
                                                                  <div class="static-area ellipsis reqd"></div>
                                                                </div>
                                                                <div class="col grid-static-col col-xs-3 " data-fieldname="total_subscribers" data-fieldtype="Read Only">
                                                                  <div class="field-area" style="display: none;"></div>
                                        ...
                                        <div class="row form-section card-section visible-section" data-fieldname="subject_section">
                                          <div class="section-head">
                                            Subject
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_5">
                                              <form>
                                                <div class="frappe-control" data-fieldtype="Small Text" data-fieldname="subject">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                    ...
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input"><textarea type="text" autocomplete="off" class="input-with-feedback form-control bold" data-fieldtype="Small Text" data-fieldname="subject" placeholder="" data-doctype="Newsletter" style="height: 150px;"></textarea></div>
                                        ...
                                        <div class="row form-section card-section visible-section" data-fieldname="newsletter_content">
                                          <div class="section-head">
                                            Content
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_6">
                                              <form>
                                                <div class="frappe-control input-max-width" data-fieldtype="Select" data-fieldname="content_type">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Content Type</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input flex align-center">
                                                        <select type="text" autocomplete="off" class="input-with-feedback form-control ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="content_type" placeholder="" data-doctype="Newsletter">
                                                      ...
                                                      <div class="control-value like-disabled-input" style="display: none;">Rich Text</div>
                                                      <p class="help-box small text-muted"></p>
                                                    </div>
                                                  </div>
                                                  <span class="tooltip-content">content_type</span>
                                                </div>
                                                <div class="frappe-control" data-fieldtype="Text Editor" data-fieldname="message">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                ...
                                                <div class="frappe-control hide-control" data-fieldtype="Markdown Editor" data-fieldname="message_md">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Message (Markdown)</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="markdown-container">
                                                          <button class="btn btn-default btn-xs markdown-toggle">Preview</button>
                                                          ...
                                                          <div class="markdown-preview border rounded" style="display: none;"></div>
                                                        </div>
                                                      </div>
                                                  ...
                                                  <span class="tooltip-content">message_md</span>
                                                </div>
                                                <div class="frappe-control hide-control" data-fieldtype="HTML Editor" data-fieldname="message_html">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Message (HTML)</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="html-container">
                                                          <button class="btn btn-default btn-xs html-toggle">Preview</button>
                                                          <div class="ace-editor-target border rounded ace_editor ace_hidpi ace-tomorrow" style="height: 300px;">
                                                            <textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" style="opacity: 0; font-size: 1px;"></textarea>
                                                            <div class="ace_gutter" aria-hidden="true">
                                                              <div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px;"></div>
                                                          ...
                                                          <div class="html-preview border rounded" style="display: none;"></div>
                                                        </div>
                                                      </div>
                                                      <div class="control-value like-disabled-input for-description" style="display: none; white-space-collapse: preserve;"></div>
                                                      <p class="help-box small text-muted"></p>
                                                  ...
                                                  <span class="tooltip-content">message_html</span>
                                                </div>
                                                <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="campaign">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;">Campaign</label>
                                                      <span class="help"></span>
                                                    </div>
                                                    <div class="control-input-wrapper">
                                                      <div class="control-input">
                                                        <div class="link-field ui-front" style="position: relative;">
                                                          <div class="awesomplete">
                                                            <input type="text" class="input-with-feedback form-control" maxlength="140" data-fieldtype="Link" data-fieldname="campaign" placeholder="" data-doctype="Newsletter" data-target="Marketing Campaign" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_3" role="combobox">
                                                  ...
                                                  <span class="tooltip-content">campaign</span>
                                                </div>
                                                <div class="frappe-control form-group" data-fieldtype="Table" data-fieldname="attachments">
                                                  <span class="tooltip-content">attachments</span>
                                                  <div class="grid-field">
                                                        ...
                                                        <div class="grid-heading-row">
                                                          <div class="grid-row">
                                                            <div class="data-row row">
                                                              ...
                                                              <div class="col grid-static-col col-xs-10 " data-fieldname="attachment" data-fieldtype="Attach" title="Attachment">
                                                                <div class="field-area" style="display: none;"></div>
                                                                <div class="static-area ellipsis reqd">Attachment</div>
                                                              </div>
                                                              <div class="col grid-static-col d-flex justify-content-center" style="cursor: pointer;">
                                                                <a>
                                                                  <svg class="icon  icon-sm" style="filter: opacity(0.5)" aria-hidden="true">
                                                ...
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="send_unsubscribe_link">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="send_unsubscribe_link" placeholder="" data-doctype="Newsletter"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-selected"></span>
                                                    <span class="label-area">Send Unsubscribe Link</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                  <span class="tooltip-content">send_unsubscribe_link</span>
                                                </div>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="send_webview_link">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="send_webview_link" placeholder="" data-doctype="Newsletter"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                    <span class="label-area">Send Web View Link</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                  <span class="tooltip-content">send_webview_link</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section hide-control" data-fieldname="schedule_settings_section">
                                          <div class="section-head">
                                            Scheduled Sending
                                            <span class="ml-2 collapse-indicator mb-1" style="display: none;"></span>
                                          </div>
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_7">
                                              <form>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Int" data-fieldname="scheduled_to_send">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">scheduled_to_send</span>
                                                </div>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="schedule_sending">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="schedule_sending" placeholder="" data-doctype="Newsletter"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                    <span class="label-area">Schedule sending at a later time</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                  <span class="tooltip-content">schedule_sending</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Datetime" data-fieldname="schedule_send">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">schedule_send</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="row form-section card-section visible-section" data-fieldname="publish_as_a_web_page_section">
                                          <div class="section-head">
                                          ...
                                          <div class="section-body">
                                            <div class="form-column col-sm-12" data-fieldname="__column_8">
                                              <form>
                                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="published">
                                                  <div class="checkbox">
                                                    <label>
                                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="published" placeholder="" data-doctype="Newsletter"></span>
                                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                                    <span class="label-area">Published</span>
                                                    <span class="ml-1 help"></span>
                                                    </label>
                                                    <p class="help-box small text-muted"></p>
                                                  </div>
                                                  <span class="tooltip-content">published</span>
                                                </div>
                                                <div class="frappe-control input-max-width hide-control" data-fieldtype="Data" data-fieldname="route">
                                                  <div class="form-group">
                                                    <div class="clearfix">
                                                      <label class="control-label" style="padding-right: 0px;"></label>
                                                      <span class="help"></span>
                                                  ...
                                                  <span class="tooltip-content">route</span>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
