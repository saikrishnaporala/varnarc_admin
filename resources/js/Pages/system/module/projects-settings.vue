...
<template>
  <Layout>
    ...
    <PageHeader title="Project Settings" pageTitle="Settings" subTitle="Module"/>
                  ...
                  <div class="std-form-layout">
                    <div class="form-layout">
                      ...
                      <div class="form-page">
                        <div class="form-dashboard">
                          ...
                          <div class="row form-dashboard-section form-heatmap hide-control" data-fieldname="undefined">
                            ...
                            <div class="section-body">
                              <div id="heatmap-projects_settings" class="heatmap"></div>
                        ...
                        <div class="row form-section card-section visible-section" data-fieldname="timesheet_sb">
                          ...
                          <div class="section-body">
                            <div class="form-column col-sm-12" data-fieldname="__column_2">
                              <form>
                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="ignore_workstation_time_overlap">
                                  <div class="checkbox">
                                    <label>
                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="ignore_workstation_time_overlap" placeholder="" data-doctype="Projects Settings"></span>
                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                    <span class="label-area">Ignore Workstation Time Overlap</span>
                                    <span class="ml-1 help"></span>
                                    </label>
                                    <p class="help-box small text-muted"></p>
                                  </div>
                                  <span class="tooltip-content">ignore_workstation_time_overlap</span>
                                </div>
                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="ignore_user_time_overlap">
                                  <div class="checkbox">
                                    <label>
                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="ignore_user_time_overlap" placeholder="" data-doctype="Projects Settings"></span>
                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                    <span class="label-area">Ignore User Time Overlap</span>
                                    <span class="ml-1 help"></span>
                                    </label>
                                    <p class="help-box small text-muted"></p>
                                  </div>
                                  <span class="tooltip-content">ignore_user_time_overlap</span>
                                </div>
                                <div class="form-group frappe-control input-max-width" data-fieldtype="Check" data-fieldname="ignore_employee_time_overlap">
                                  <div class="checkbox">
                                    <label>
                                    <span class="input-area"><input type="checkbox" autocomplete="off" class="input-with-feedback" data-fieldtype="Check" data-fieldname="ignore_employee_time_overlap" placeholder="" data-doctype="Projects Settings"></span>
                                    <span class="disp-area" style="display: none;"><input type="checkbox" disabled="" class="disabled-deselected"></span>
                                    <span class="label-area">Ignore Employee Time Overlap</span>
                                    <span class="ml-1 help"></span>
                                    </label>
                                    <p class="help-box small text-muted"></p>
                                  </div>
                                  <span class="tooltip-content">ignore_employee_time_overlap</span>
                                </div>
                              </form>
                            </div>
                          </div>
