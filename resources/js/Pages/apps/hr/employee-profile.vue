<script lang="ts" setup>
  ...
  // Define reactive properties with type annotations
  const value = ref<string[]>(['javascript']);
  ...
  const event = ref({
    ...
    "coach_id": null,
    "currency_id": null,
    "created_at": "2024-10-26T19:53:51.000000Z",
    "updated_at": "2024-10-26T19:53:51.000000Z",
    "deleted_at": null,
    "nationality": null,
    "image": null,
    "empid": "1001",
  ...
  const fetchEmployeeById = async () => {
    ...
    error.value = null;
    try {
      const response = await axios.get('/api/employees/byId/'+page.props.empid);
