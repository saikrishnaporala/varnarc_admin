...
<template>
  <Layout>
    ...
    <PageHeader title="Opportunities" pageTitle="CRM" />
    <BRow>
      <BCol lg="12">
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
                                      ...
                                      <div class="widget dashboard-widget-box" data-widget-name="j5kecv3eon">
                                        <div class="widget-head">
                                          <div class="widget-label">
                                            ...
                                            <div class="widget-subtitle">Last synced <span class="frappe-timestamp " data-timestamp="2024-11-26 00:44:19.310035" title="26-11-2024 00:44:19">5 minutes ago</span></div>
                                          </div>
          ...
          <div class="content page-container" id="page-List/Opportunity/List" data-page-route="List/Opportunity/List" style="">
