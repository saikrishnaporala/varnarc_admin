...
<template>
  <Layout>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Customer/List" data-page-route="List/Customer/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="" data-original-title="Buyer of Goods and Services.">Customer</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Customer">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Customer"> <span><span class="alt-underline">A</span>dd Customer</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="layout-main-section frappe-card">
                        <div class="page-form flex">
                          <div class="standard-filter-section flex">
                            ...
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Link" data-fieldname="customer_group" title="" data-original-title="Customer Group">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Link" data-fieldname="customer_group" placeholder="Customer Group" data-target="Customer Group" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_2" role="combobox">
                            ...
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Link" data-fieldname="territory" title="" data-original-title="Territory">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Link" data-fieldname="territory" placeholder="Territory" data-target="Territory" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_3" role="combobox">
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="customer_type">       Customer Type      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="customer_group">       Customer Group      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="territory">       Territory      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="gst_category">       GST Category      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="customer_group" title="Click to sort by Customer Group">Customer Group</span></div>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer" data-name="Palmer Productions Ltd."></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer" data-name="Palmer Productions Ltd." href="/app/customer/Palmer%20Productions%20Ltd." title="Palmer Productions Ltd.">Palmer Productions Ltd.</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col hidden-xs ellipsis">
                                    <span class="indicator-pill blue filterable no-indicator-dot ellipsis" data-filter="disabled,=,0" title="Document is in draft state">
                                    <span class="ellipsis"> Enabled</span>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group: Demo Customer Group">
                                    <a class="filterable ellipsis" data-filter="customer_group,=,Demo Customer Group">
                                    Demo Customer Group
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Territory: ">
                                    <a class="filterable ellipsis" data-filter="territory,=,">
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="ID: Palmer Productions Ltd.">
                                    <a class="filterable ellipsis" data-filter="name,=,Palmer Productions Ltd.">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:25.103031" title="24-11-2024 14:01:25">2 d</span></span>
                                    ...
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer" data-name="Palmer Productions Ltd." data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer" data-name="West View Software Ltd."></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer" data-name="West View Software Ltd." href="/app/customer/West%20View%20Software%20Ltd." title="West View Software Ltd.">West View Software Ltd.</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  ...
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="ID: West View Software Ltd.">
                                    <a class="filterable ellipsis" data-filter="name,=,West View Software Ltd.">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:25.096088" title="24-11-2024 14:01:25">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer" data-name="West View Software Ltd." data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer" data-name="Grant Plastics Ltd."></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer" data-name="Grant Plastics Ltd." href="/app/customer/Grant%20Plastics%20Ltd." title="Grant Plastics Ltd.">Grant Plastics Ltd.</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  ...
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="ID: Grant Plastics Ltd.">
                                    <a class="filterable ellipsis" data-filter="name,=,Grant Plastics Ltd.">
                                    Grant Plastics Ltd.
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:25.038933" title="24-11-2024 14:01:25">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer" data-name="Grant Plastics Ltd." data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>Buyer of Goods and Services.</p>
