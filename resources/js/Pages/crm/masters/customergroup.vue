...
<template>
  <Layout>
    ...
    <Head title="Customer Group" />
    <PageHeader title="Customer Group" pageTitle="CRM" subTitle="Masters"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Customer Group/List" data-page-route="List/Customer Group/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="Customer Group">Customer Group</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li data-view="Tree">
                            <a class="grey-link dropdown-item" href="#" onclick="return false;">
                              ...
                              <span class="menu-item-label" data-label="Tree%20View"><span><span class="alt-underline">T</span>ree View</span></span>
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Customer Group">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Customer%20Group"> <span><span class="alt-underline">A</span>dd Customer Group</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="customer_group_name">       Customer Group Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="parent_customer_group">       Parent Customer Group      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="is_group">       Is Group      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="customer_group_name" title="Click to sort by Customer Group Name">Customer Group Name</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="parent_customer_group" title="Click to sort by Parent Customer Group">Parent Customer Group</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="is_group" title="Click to sort by Is Group">Is Group</span></div>
                              </div>
                              ...
                              <div class="level-right">
                                <span class="list-count"><span>6 of 6</span></span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="Demo Customer Group"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="Demo Customer Group" href="/app/customer-group/Demo%20Customer%20Group" title="Demo Customer Group">Demo Customer Group</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: Demo Customer Group">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,Demo Customer Group">
                                    Demo Customer Group
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Parent Customer Group: All Customer Groups">
                                    <a class="filterable ellipsis" data-filter="parent_customer_group,=,All Customer Groups">
                                    All Customer Groups
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Is Group: ">
                                    <a class="filterable ellipsis" data-filter="is_group,=,">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:24.913662" title="24-11-2024 14:01:24">2 d</span></span>
                                    ...
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="Demo Customer Group" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="Government"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="Government" href="/app/customer-group/Government" title="Government">Government</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: Government">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,Government">
                                    Government
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:02.065452" title="24-11-2024 14:01:02">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="Government" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="Non Profit"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="Non Profit" href="/app/customer-group/Non%20Profit" title="Non Profit">Non Profit</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: Non Profit">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,Non Profit">
                                    Non Profit
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:02.051147" title="24-11-2024 14:01:02">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="Non Profit" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="Commercial"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="Commercial" href="/app/customer-group/Commercial" title="Commercial">Commercial</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: Commercial">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,Commercial">
                                    Commercial
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:02.036509" title="24-11-2024 14:01:02">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="Commercial" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="Individual"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="Individual" href="/app/customer-group/Individual" title="Individual">Individual</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: Individual">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,Individual">
                                    Individual
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:02.015684" title="24-11-2024 14:01:02">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="Individual" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Customer Group" data-name="All Customer Groups"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Customer Group" data-name="All Customer Groups" href="/app/customer-group/All%20Customer%20Groups" title="All Customer Groups">All Customer Groups</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Customer Group Name: All Customer Groups">
                                    <a class="filterable ellipsis" data-filter="customer_group_name,=,All Customer Groups">
                                    All Customer Groups
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Parent Customer Group: ">
                                    <a class="filterable ellipsis" data-filter="parent_customer_group,=,">
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Is Group: 1">
                                    <a class="filterable ellipsis" data-filter="is_group,=,1">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:01.990956" title="24-11-2024 14:01:01">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Customer Group" data-name="All Customer Groups" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a Customer Group yet</p>
