...
<template>
  <Layout>
    ...
    <PageHeader title="Sales Person" pageTitle="CRM" subTitle="Masters"/>
    <BRow>
      <BCol lg="12">
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Sales Person/List" data-page-route="List/Sales Person/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="" data-original-title="All Sales Transactions can be tagged against multiple Sales Persons so that you can set and monitor targets.">Sales Person</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Sales Person">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Sales%20Person"> <span><span class="alt-underline">A</span>dd Sales Person</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="sales_person_name">       Sales Person Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="parent_sales_person">       Parent Sales Person      </a>     </li>
                          ...
                          <div class="result">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="sales_person_name" title="Click to sort by Sales Person Name">Sales Person Name</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="parent_sales_person" title="Click to sort by Parent Sales Person">Parent Sales Person</span></div>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Sales Person" data-name="Sales Team"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Sales Person" data-name="Sales Team" href="/app/sales-person/Sales%20Team" title="Sales Team">Sales Team</a></span>
                                  </div>
                                  ...
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Sales Person Name: Sales Team">
                                    <a class="filterable ellipsis" data-filter="sales_person_name,=,Sales Team">
                                    Sales Team
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Parent Sales Person: ">
                                    <a class="filterable ellipsis" data-filter="parent_sales_person,=,">
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:02.233111" title="24-11-2024 14:01:02">2 d</span></span>
                                    ...
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Sales Person" data-name="Sales Team" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>All Sales Transactions can be tagged against multiple Sales Persons so that you can set and monitor targets.</p>
