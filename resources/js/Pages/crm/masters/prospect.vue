...
<template>
  <Layout>
    ...
    <Head title="Prospect" />
    <PageHeader title="Prospect" pageTitle="CRM" subTitle="Masters"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Prospect/List" data-page-route="List/Prospect/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="Prospect">Prospect</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Prospect">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Prospect"> <span><span class="alt-underline">A</span>dd Prospect</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="layout-main-section frappe-card">
                        <div class="page-form flex">
                          <div class="standard-filter-section flex">
                            ...
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Data" data-fieldname="company_name" title="" data-original-title="Company Name"><input type="text" autocomplete="off" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Data" data-fieldname="company_name" placeholder="Company Name"><span class="tooltip-content">company_name</span></div>
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Link" data-fieldname="industry" title="" data-original-title="Industry">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Link" data-fieldname="industry" placeholder="Industry" data-target="Industry Type" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_2" role="combobox">
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="company_name">       Company Name      </a>     </li>
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="annual_revenue">       Annual Revenue      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="industry">       Industry      </a>     </li>
                            ...
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                <div class="list-row-col ellipsis list-subject level  ">
                                  ...
                                  <span class="level-item" data-sort-by="company_name" title="Click to sort by Company Name">
                                  Company Name
                                  </span>
                                </div>
                                <div class="list-row-col ellipsis hidden-xs tag-col hide "><span>Tag</span></div>
                                <div class="list-row-col ellipsis hidden-xs  text-right"><span data-sort-by="annual_revenue" title="Click to sort by Annual Revenue">Annual Revenue</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="industry" title="Click to sort by Industry">Industry</span></div>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a Prospect yet</p>
