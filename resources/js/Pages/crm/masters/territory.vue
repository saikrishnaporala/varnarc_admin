...
<template>
  <Layout>
    ...
    <PageHeader title="Territory" pageTitle="CRM" subTitle="Masters"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
            <div class="d-flex align-items-center flex-wrap gap-2">
              <div class="flex-grow-1">
                <BButton variant="info" class="add-btn me-1" @click="toggleModal">
                  <i class="ri-add-fill me-1 align-bottom"></i> Add Territory
                </BButton>
              </div>
      ...
      <BCol xxl="9">
        <BCard no-body id="objList">
          <BCardHeader>
            <BRow class="g-2">
              <BCol md="3">
                <div class="search-box">
                  <input type="text" class="form-control search" placeholder="Search for territory..." v-model="searchQuery" />
                ...
                <table class="table align-middle table-nowrap mb-0" id="customerTable">
                  <thead class="table-light">
                    <tr>
                      ...
                      <th class="sort" data-sort="name" scope="col" @click="onSort('name')">Territory Name</th>
                      <th class="sort" data-sort="owner" scope="col" @click="onSort('parent')">Parent Territory</th>
                      <th class="sort" data-sort="industry_type" scope="col" @click="onSort('manager')">Territory Manager</th>
                      <th class="sort" data-sort="star_value" scope="col" @click="onSort('isGroup')">Is Group</th>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Territory/List" data-page-route="List/Territory/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="" data-original-title="Classification of Customers by region">Territory</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Territory">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Territory"> <span><span class="alt-underline">A</span>dd Territory</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="territory_name">       Territory Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="parent_territory">       Parent Territory      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="is_group">       Is Group      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="territory_manager">       Territory Manager      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="territory_name" title="Click to sort by Territory Name">Territory Name</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="parent_territory" title="Click to sort by Parent Territory">Parent Territory</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="is_group" title="Click to sort by Is Group">Is Group</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="territory_manager" title="Click to sort by Territory Manager">Territory Manager</span></div>
                              </div>
                              ...
                              <div class="level-right">
                                <span class="list-count"><span>3 of 3</span></span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Territory" data-name="Rest Of The World"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Territory" data-name="Rest Of The World" href="/app/territory/Rest%20Of%20The%20World" title="Rest Of The World">Rest Of The World</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Territory Name: Rest Of The World">
                                    <a class="filterable ellipsis" data-filter="territory_name,=,Rest Of The World">
                                    Rest Of The World
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Parent Territory: All Territories">
                                    <a class="filterable ellipsis" data-filter="parent_territory,=,All Territories">
                                    All Territories
                                    </a>
                                    </span>
                                  </div>
                                  ...
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Territory Manager: ">
                                    <a class="filterable ellipsis" data-filter="territory_manager,=,">
                                    </a>
                                    </span>
                                  </div>
                                </div>
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:01.927710" title="24-11-2024 14:01:01">2 d</span></span>
                                    ...
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Territory" data-name="Rest Of The World" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Territory" data-name="India"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Territory" data-name="India" href="/app/territory/India" title="India">India</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Territory Name: India">
                                    <a class="filterable ellipsis" data-filter="territory_name,=,India">
                                    India
                                    </a>
                                    </span>
                                  </div>
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:01.909292" title="24-11-2024 14:01:01">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Territory" data-name="India" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                            ...
                            <div class="list-row-container" tabindex="1">
                              <div class="level list-row">
                                <div class="level-left ellipsis">
                                  <div class="list-row-col ellipsis list-subject level ">
                                    <span class="level-item select-like"><input class="list-row-checkbox" type="checkbox" data-doctype="Territory" data-name="All Territories"></span><span class="level-item bold ellipsis"><a class="ellipsis" data-doctype="Territory" data-name="All Territories" href="/app/territory/All%20Territories" title="All Territories">All Territories</a></span>
                                  </div>
                                  <div class="list-row-col tag-col hide hidden-xs ellipsis">
                                    <div class="tags-empty">-</div>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Territory Name: All Territories">
                                    <a class="filterable ellipsis" data-filter="territory_name,=,All Territories">
                                    All Territories
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                    <span class="ellipsis" title="Parent Territory: ">
                                    <a class="filterable ellipsis" data-filter="parent_territory,=,">
                                    </a>
                                    </span>
                                  </div>
                                  <div class="list-row-col ellipsis hidden-xs ">
                                ...
                                <div class="level-right text-muted ellipsis">
                                  <div class="level-item list-row-activity hidden-xs">
                                    ...
                                    <span class="modified"><span class="frappe-timestamp  mini" data-timestamp="2024-11-24 14:01:01.891150" title="24-11-2024 14:01:01">2 d</span></span>
                                    <span class="comment-count d-flex align-items-center">
                                      <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                        <use class="" href="#es-line-chat-alt"></use>
                                      </svg>
                                    ...
                                    <span class="mx-2">·</span>
                                    <span class="list-row-like hidden-xs" style="margin-bottom: 1px;">
                                      <span class="like-action not-liked" data-doctype="Territory" data-name="All Territories" data-liked-by="" title="">
                                        <svg class="es-icon es-line  icon-sm" style="" aria-hidden="true">
                                          <use class="like-icon" href="#es-solid-heart"></use>
                                        </svg>
                                      </span>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="display: none;">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>Classification of Customers by region</p>
