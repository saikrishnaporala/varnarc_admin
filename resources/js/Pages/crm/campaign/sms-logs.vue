...
<template>
  <Layout>
    ...
    <Head title="SMS Logs" />
    <PageHeader title="SMS Logs" pageTitle="CRM" subTitle="Campaign"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/SMS Log/List" data-page-route="List/SMS Log/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="SMS Log">SMS Log</h3>
                    ...
                    <div class="standard-actions flex">
                      ...
                      <div class="actions-btn-group hide">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                          <li>
                            <a class="grey-link dropdown-item" href="#" onclick="return false;">
                            <span class="menu-item-label" data-label="Export"><span><span class="alt-underline">E</span>xport</span></span>
                            </a>
                          </li>
                          <li>
                            <a class="grey-link dropdown-item" href="#" onclick="return false;">
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a SMS Log yet</p>
                              </div>
                            </div>
                          </div>
