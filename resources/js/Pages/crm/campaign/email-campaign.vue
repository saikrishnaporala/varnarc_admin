...
<template>
  <Layout>
    ...
    <PageHeader title="Email Campaign" pageTitle="CRM" subTitle="Campaign"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Email Campaign/List" data-page-route="List/Email Campaign/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="Email Campaign">Email Campaign</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Email Campaign">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Email%20Campaign"> <span><span class="alt-underline">A</span>dd Email Campaign</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="campaign_name">       Campaign      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="email_campaign_for">       Email Campaign For       </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="recipient">       Recipient      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="start_date">       Start Date      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result" style="display: none;">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="campaign_name" title="Click to sort by Campaign">Campaign</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="email_campaign_for" title="Click to sort by Email Campaign For ">Email Campaign For </span></div>
                              </div>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a Email Campaign yet</p>
