...
<template>
  <Layout>
    ...
    <PageHeader title="Contracts" pageTitle="CRM" />
    <BRow>
      <BCol lg="12">
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
                                      ...
                                      <div class="widget dashboard-widget-box" data-widget-name="j5kecv3eon">
                                        <div class="widget-head">
                                          <div class="widget-label">
                                            ...
                                            <div class="widget-subtitle">Last synced <span class="frappe-timestamp " data-timestamp="2024-11-26 00:56:26.947857" title="26-11-2024 00:56:26">7 minutes ago</span></div>
                                          </div>
          ...
          <div class="content page-container" id="page-List/Lead/List" data-page-route="List/Lead/List" style="display: none;">
            <div class="page-head flex" style="top: var(--navbar-height);">
              <div class="container">
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="col-lg-2 layout-side-section hide-sidebar">
                      <div class="form-sidebar overlay-sidebar hidden-xs hidden-sm" style="display: none;">
                        ...
                        <ul class="list-unstyled sidebar-menu form-tags">
                          ...
                          <li class="" style="display: none;">
                            <div class="awesomplete">
                              <input class="tags-input form-control" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_30" role="combobox">
                              <ul hidden="" role="listbox" id="awesomplete_list_30"></ul>
                              <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">Begin typing for results.</span>
                            </div>
                          </li>
                        </ul>
                                            ...
                                            <div class="frappe-control input-max-width" data-fieldtype="Link" data-fieldname="language">
                                              <div class="form-group">
                                                ...
                                                <div class="control-input-wrapper">
                                                  ...
                                                  <div class="control-value like-disabled-input" style="display: none;"><a href="/app/language/en" data-doctype="Language" data-name="en" data-value="en">English</a></div>
                                                  <p class="help-box small text-muted"></p>
                                                </div>
                                              </div>
          ...
          <div class="content page-container" id="page-List/Opportunity/List" data-page-route="List/Opportunity/List" style="display: none;">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="" data-original-title="Potential Sales Deal">Opportunity</h3>
                          <span class="indicator-pill whitespace-nowrap"></span>       
                        </div>
                        <div class="ellipsis sub-heading hide text-muted"></div>
                      </div>
                    ...
                    <div class="standard-actions flex">
                      ...
                      <div class="menu-btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                          ...
                          <li class="user-action">
                            <a class="grey-link dropdown-item" href="#" onclick="return false;">
                            <span class="menu-item-label" data-label="Set%20as%20Open"><span>S<span class="alt-underline">e</span>t as Open</span></span>
                            </a>
                          </li>
                          <li class="user-action">
                            <a class="grey-link dropdown-item" href="#" onclick="return false;">
                            <span class="menu-item-label" data-label="Set%20as%20Closed"><span>Set <span class="alt-underline">a</span>s Closed</span></span>
                            </a>
                          </li>
                          <li class="dropdown-divider user-action"></li>
                          <li>
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Opportunity">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Opportunity"> <span><span class="alt-underline">A</span>dd Opportunity</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col layout-main-section-wrapper">
                      <div class="layout-main-section frappe-card">
                        <div class="page-form flex">
                          <div class="standard-filter-section flex">
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Data" data-fieldname="name" title="" data-original-title="ID"><input type="text" autocomplete="off" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Data" data-fieldname="name" placeholder="ID"><span class="tooltip-content">name</span></div>
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Link" data-fieldname="opportunity_from" title="" data-original-title="Opportunity From">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Link" data-fieldname="opportunity_from" placeholder="Opportunity From" data-target="DocType" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_34" role="combobox">
                                  <ul hidden="" role="listbox" id="awesomplete_list_34"></ul>
                                  <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">Begin typing for results.</span>
                                </div>
                              </div>
                              <span class="tooltip-content">opportunity_from</span>
                            </div>
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Dynamic Link" data-fieldname="party_name" title="" data-original-title="Party">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Dynamic Link" data-fieldname="party_name" placeholder="Party" data-target="opportunity_from" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_35" role="combobox">
                                  <ul hidden="" role="listbox" id="awesomplete_list_35"></ul>
                                  <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">Begin typing for results.</span>
                                </div>
                              </div>
                              <span class="tooltip-content">party_name</span>
                            </div>
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Select" data-fieldname="status" title="" data-original-title="Status">
                              <select type="text" autocomplete="off" class="input-with-feedback form-control input-xs ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="status" placeholder="Status">
                                <option></option>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="opportunity_from">       Opportunity From      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="party_name">       Party      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="customer_name">       Customer Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="status">       Status      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="opportunity_type">       Opportunity Type      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="company">       Company      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="transaction_date">       Opportunity Date      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="first_response_time">       First Response Time      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result" style="display: none;">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs tag-col hide "><span>Tag</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span>Status</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="naming_series" title="Click to sort by Series">Series</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="opportunity_from" title="Click to sort by Opportunity From">Opportunity From</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="opportunity_type" title="Click to sort by Opportunity Type">Opportunity Type</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="name" title="Click to sort by ID">ID</span></div>
                              </div>
                              <div class="level-left checkbox-actions">
                                <div class="level list-subject">
          ...
          <div class="content page-container" id="page-List/Contract/List" data-page-route="List/Contract/List" style="">
            <div class="page-head flex">
              <div class="container">
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="Contract">Contract</h3>
                          <span class="indicator-pill whitespace-nowrap"></span>       
                        </div>
                        <div class="ellipsis sub-heading hide text-muted"></div>
                      </div>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Contract">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Contract"> <span><span class="alt-underline">A</span>dd Contract</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col layout-main-section-wrapper">
                      <div class="layout-main-section frappe-card">
                        <div class="page-form flex">
                          <div class="standard-filter-section flex">
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Data" data-fieldname="name" title="" data-original-title="ID"><input type="text" autocomplete="off" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Data" data-fieldname="name" placeholder="ID"><span class="tooltip-content">name</span></div>
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Dynamic Link" data-fieldname="party_name" title="" data-original-title="Party Name">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Dynamic Link" data-fieldname="party_name" placeholder="Party Name" data-target="party_type" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_39" role="combobox">
                                  <ul hidden="" role="listbox" id="awesomplete_list_39"></ul>
                                  <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">Begin typing for results.</span>
                                </div>
                              </div>
                              <span class="tooltip-content">party_name</span>
                            ...
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Select" data-fieldname="fulfilment_status" title="" data-original-title="Fulfilment Status">
                              <select type="text" autocomplete="off" class="input-with-feedback form-control input-xs ellipsis" maxlength="140" data-fieldtype="Select" data-fieldname="fulfilment_status" placeholder="Fulfilment Status">
                                <option></option>
                              ...
                              <span class="tooltip-content">fulfilment_status</span>
                              <div class="select-icon xs">
                                <svg class="icon  icon-xs" style="" aria-hidden="true">
                                  <use class="" href="#icon-select"></use>
                                </svg>
                            ...
                            <div class="form-group frappe-control input-max-width col-md-2" data-fieldtype="Dynamic Link" data-fieldname="document_name" title="" data-original-title="Document Name">
                              <div class="link-field ui-front" style="position: relative;">
                                <div class="awesomplete">
                                  <input type="text" class="input-with-feedback form-control input-xs" maxlength="140" data-fieldtype="Dynamic Link" data-fieldname="document_name" placeholder="Document Name" data-target="document_type" autocomplete="off" aria-expanded="false" aria-owns="awesomplete_list_40" role="combobox">
                                  <ul hidden="" role="listbox" id="awesomplete_list_40"></ul>
                                  <span class="visually-hidden" role="status" aria-live="assertive" aria-atomic="true">Begin typing for results.</span>
                                </div>
                              </div>
                              <span class="tooltip-content">document_name</span>
                            </div>
                          </div>
                          <div class="filter-section flex">
                            <div class="filter-selector">
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="creation">       Created On      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="idx">       Most Used      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="party_type">       Party Type      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="party_name">       Party Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="status">       Status      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="fulfilment_status">       Fulfilment Status      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="signed_on">       Signed On      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="contract_terms">       Contract Terms      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="document_name">       Document Name      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result" style="display: none;">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs tag-col hide "><span>Tag</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span>Status</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="fulfilment_status" title="Click to sort by Fulfilment Status">Fulfilment Status</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="signed_on" title="Click to sort by Signed On">Signed On</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="contract_terms" title="Click to sort by Contract Terms">Contract Terms</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="document_name" title="Click to sort by Document Name">Document Name</span></div>
                              </div>
                              <div class="level-left checkbox-actions">
                                <div class="level list-subject">
                                  <input class="level-item list-check-all" type="checkbox" title="Select All">
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a Contract yet</p>
                                <p><button class="btn btn-default btn-sm btn-new-doc hidden-xs">
