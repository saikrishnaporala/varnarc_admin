...
<template>
  <Layout>
    ...
    <PageHeader title="Appointment" pageTitle="CRM" subTitle="Sales"/>
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
          <div class="content page-container" id="page-List/Appointment/List" data-page-route="List/Appointment/List" style="">
                ...
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
                    ...
                    <div class="flex fill-width title-area">
                      <div>
                        <div class="flex">
                          <h3 class="ellipsis title-text" title="Appointment">Appointment</h3>
                  ...
                  <div class="flex col page-actions justify-content-end">
                    ...
                    <div class="standard-actions flex">
                      ...
                      <button class="btn btn-primary btn-sm primary-action" data-label="Add Appointment">
                        <svg class="icon  icon-xs" style="" aria-hidden="true">
                          <use class="" href="#icon-add"></use>
                        </svg>
                        <span class="hidden-xs" data-label="Add%20Appointment"> <span><span class="alt-underline">A</span>dd Appointment</span> </span>
                      </button>
                    </div>
                  </div>
                </div>
                              ...
                              <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm sort-selector-button" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>      <a class="dropdown-item option" data-value="scheduled_time">       Scheduled Time      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="status">       Status      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="customer_name">       Name      </a>     </li>
                                    <li>      <a class="dropdown-item option" data-value="customer_email">       Email      </a>     </li>
                                  </ul>
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="result" style="display: none;">
                            <header class="level list-row-head text-muted">
                              <div class="level-left list-header-subject">
                                ...
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="scheduled_time" title="Click to sort by Scheduled Time">Scheduled Time</span></div>
                                <div class="list-row-col ellipsis hidden-xs  "><span data-sort-by="customer_name" title="Click to sort by Name">Name</span></div>
                              </div>
                          ...
                          <div class="no-result text-muted flex justify-center align-center" style="">
                            <div class="no-result text-muted flex justify-center align-center">
                              <div class="msg-box no-border">
                                ...
                                <p>You haven't created a Appointment yet</p>
