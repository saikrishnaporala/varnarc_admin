...
<template>
  <Layout>
    <Head title="Maintenance Visit" />
    <PageHeader title="Maintenance Visit" pageTitle="CRM" subTitle="Maintenance"/>
    <BRow>
      <BCol lg="12">
    ...
    <BRow>
      <BCol lg="12">
        <div id="body">
                                      ...
                                      <div class="widget dashboard-widget-box" data-widget-name="j5kecv3eon">
                                        <div class="widget-head">
                                          <div class="widget-label">
                                            ...
                                            <div class="widget-subtitle">Last synced <span class="frappe-timestamp " data-timestamp="2024-11-29 01:36:12.344613" title="29-11-2024 01:36:12">just now</span></div>
                                          </div>
          ...
          <div class="content page-container" id="page-List/Maintenance Visit/List" data-page-route="List/Maintenance Visit/List" style="">
            <div class="page-head flex">
              <div class="container">
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
          ...
          <div class="content page-container editable-form" id="page-Maintenance Visit" data-page-route="Maintenance Visit" style="" data-state="dirty">
            <div class="page-head flex">
              <div class="container">
                <div class="row flex align-center page-head-content justify-between">
                  <div class="col-md-4 col-sm-6 col-xs-7 page-title">
