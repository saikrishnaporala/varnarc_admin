                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('build/images/nft/wallet.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('build/images/nft/money.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('build/images/nft/add.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('build/images/nft/sell.png')}}" alt="" class="avatar-sm">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
